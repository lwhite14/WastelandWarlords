...
public static class ResourceFactory
{
    ...
    public static GameObject            BuildingMarker           = Resources.Load<GameObject>("GameObjects/Markers/BuildingMarker");
    ...
    public static SettlementBuilding    Granary                 = Resources.Load<SettlementBuilding>("GameObjects/Settlements/Granary");
    public static SettlementBuilding    Market                  = Resources.Load<SettlementBuilding>("GameObjects/Settlements/Market");
